    ...
    <>
      ...
      <AccordionContainer id="questions">
        ...
        <Accordion title="O que é menopausa?">
          <p>
            A menopausa é marcada pela ausência de menstruação por 12 meses
            consecutivos.
          </p>
          <p>
            Antes disso, a mulher passa por uma fase de transição chamada
            climatério, que pode incluir diversos sintomas.
          </p>
        </Accordion>
        <Accordion title="O que é climatério?">
          <p>
            No climatério há uma diminuição das funções ovarianas, fazendo com
            que os ciclos menstruais se tornem irregulares, até cessarem por
            completo.
          </p>
          <p>A menopausa ocorre, em média, aos 50 anos.</p>
          <p>
            O climatério tem início por volta dos 40 anos e se estende até os 65
            anos.
          </p>
        </Accordion>
        <Accordion title="Quais são os sintomas mais comuns?">
          <p>
            Os sintomas mais comuns são: Menstruação irregular, Ondas de calor,
            Alteração no sono, Oscilações de humor, Mudanças urogenitais.
          </p>
        </Accordion>
        <Accordion title="O que acontece com os hormônios?">
          <p>
            No climatério, os níveis de estrogênio e progesterona, hormônios
            femininos, diminuem de forma permanente.
          </p>
          <p>
            A chegada do climatério provoca irregularidades menstruais,
            hemorragias ou escassez no fluxo.
          </p>
        </Accordion>
        <hr />
      </AccordionContainer>
      <AccordionContainer id="types">
        ...
        <Accordion title="Menopausa Natural">
          <p>
            O que é: É o tipo mais comum, ocorrendo espontaneamente entre os 45
            e 55 anos, devido à depleção natural dos óvulos nos ovários.
          </p>
          <p>Causas: Envelhecimento fisiológico dos ovários.</p>
        </Accordion>
        <Accordion title="Menopausa Induzida">
          <p>
            O que é: Ocorre precocemente devido a fatores externos, como
            cirurgias ou tratamentos médicos.
          </p>
          <p>
            Causas: Cirúrgica: remoção dos ovários (ooforectomia) por razões
            médicas; Tratamentos: Quimioterapia, radioterapia, ou outros
            tratamentos que danificam os ovários.
          </p>
        </Accordion>
        <Accordion title="Menopausa Precoce">
          <p>
            O que é: Ocorre antes dos 40 anos, tanto de forma natural quanto
            induzida.
          </p>
          <p>
            Causas: Genética: Mutações genéticas podem levar à falência ovariana
            precoce. Autoimunes: Doenças autoimunes podem atacar os ovários.
          </p>
      ...
      <AccordionContainer id="treatments">
        ...
        <Accordion
          text="Quando o tratamento estrogênico é liberado diretamente na vagina.
        ...
        />
        <Accordion
          text="Disponível em comprimido, patch transdérmico, anel,
        ...
        />
        <Accordion
          text="Podem ser uma estratégia de cuidado para ajudar a aliviar os sintomas da menopausa.
      ...
      <AccordionContainer id="professionals">
        ...
        <Accordion
          text="O ginecologista é o primeiro profissional que a maioria das mulheres consulta ao perceber os sintomas da menopausa.
        ...
        />
        <Accordion
          text="O endocrinologista é especialista em hormônios. Ele pode ser consultado em casos mais complexos, como:
        ...
        />
        <Accordion
          text="Uma alimentação equilibrada é fundamental para o bem-estar durante a menopausa. O nutricionista pode te ajudar a:
        ...
        />
        <Accordion
          text="A fisioterapia pode ser muito benéfica para aliviar os sintomas da menopausa, como:
        ...
        />
        <Accordion
          text="O fitoterapeuta é um profissional de saúde especializado no uso de plantas medicinais para tratar, prevenir ou aliviar doenças.
        ...
        />
        <Accordion
          text="As mudanças hormonais da menopausa podem afetar o humor e o bem-estar emocional. O psicólogo pode te ajudar a:
      ...
      <AccordionContainer id="fitoterapics">
        ...
        <Accordion
          text="Diversos fitoterápicos demonstraram potencial para aliviar os sintomas da menopausa. Alguns dos mais utilizados são:
        ...
        />
        <Accordion
          text="Os fitoterápicos atuam de diversas formas para aliviar os sintomas da menopausa:
        ...
        />
        <Accordion
          text="Alívio natural dos sintomas: Os fitoterápicos oferecem uma alternativa natural para o tratamento dos sintomas da menopausa,
        ...
        />
        <Accordion
          text="Consulta médica: É fundamental consultar um médico ou profissional de saúde antes de iniciar qualquer tratamento com fitoterápicos,
      ...
      <AccordionContainer id="diseases">
        ...
        <Accordion
          text="A diminuição da produção de estrogênio e progesterona durante a menopausa pode levar a uma maior resistência à insulina.
        ...
        />
        <Accordion
          text="A menopausa pode causar uma redução do metabolismo, o que pode levar ao ganho de peso, especialmente na região abdominal.
        ...
        <Accordion
          text="A dislipidemia:  é uma condição que se caracteriza por níveis elevados de lipídios, ou seja, gorduras, no sangue.
      ...
      <AccordionContainer id="sexual">
        ...
        />
        <Accordion
          text="Tratamentos hormonais para a menopausa e seus efeitos na sexualidade.
      ...
      <AccordionContainer id="mental">
        ...
        />
        <Accordion
          text="Se você estiver enfrentando dificuldades para lidar com as emoções, sentir-se sobrecarregada ou perceber que os sintomas estão interferindo na sua vida, não hesite em procurar ajuda de um profissional de saúde mental. Um psiquiatra ou psicólogo poderá oferecer o tratamento adequado e ajudá-la a superar esse momento."
      ...
      <AccordionContainer id="myths">
        ...
        <Accordion
          text="Verdade: A menopausa é uma fase da vida, não uma doença.
        ...
        />
        <Accordion
          text="Verdade: A menopausa coincide com o processo natural de envelhecimento, mas não o acelera.
        ...
        />
        <Accordion
          text="Verdade: Os sintomas da menopausa variam muito de mulher para mulher, e algumas podem não apresentar nenhum sintoma significativo.
        ...
        />
        <Accordion
          text="Verdade: A reposição hormonal (RH) pode ser uma opção para aliviar alguns sintomas, mas não é indicada para todas as mulheres e apresenta riscos.
        ...
        />
        <Accordion
          text="Verdade: A libido pode diminuir devido a fatores físicos e emocionais, mas não é uma regra.
        ...
        />
        <Accordion
          text="Verdade: Embora as alterações hormonais possam contribuir para alterações de humor, a menopausa não causa necessariamente depressão.
        ...
        />
        <Accordion
          text="Verdade: As flutuações hormonais podem causar irritabilidade, mas nem todas as mulheres experimentam esse sintoma.
        ...
        />
        <Accordion
          text="A literatura científica sobre a menopausa é vasta e aborda diversos aspectos dessa fase da vida.
